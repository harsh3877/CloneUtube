...
const Watch = () => {
  return (
    <div className="Watch">
      <div className="row">
        <div className="video__watch left__bar" style={{ flex: "0.6" }}>
          <div className="video__container d__flex">
            <iframe
              width="706"
              height="397"
              src="https://www.youtube.com/embed/6nxrllqnP2Q?list=RD6nxrllqnP2Q"
            ...
            <span className="video__trending">#10 ON TRENDING FOR MUSIC</span>
            <span className="video__titile">
              Chauffeur: Official Music Video | Diljit Dosanjh x Tory Lanez |
              Ikky
            </span>

            <div className="video__options">
            <div className="video__option__left">
               <span className="video__single__option">17,158,053 views...</span>
               </div>
               <div className="video__option__right">
               
               <span className="video__single__option">
                <svg
                  viewBox="0 0 24 24"
        ...
        <div className="video__watch right__bar" style={{ flex: "0.4" }}></div>
      </div>
    </div>
  );
};
