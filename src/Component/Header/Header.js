...
import "./Header.css";
import userImg from "../../images/userlogo.jpg"
import { Link } from "react-router-dom";

const Header = () => {
  return (
    <div className="header d__flex align__items__center justify__content__space__between">
      <div className="header__left__items d__flex align__items__center ">
        <div className="menubar top__menu__icons">
      ...
      <div className="header__middle__items d__flex align__items__center">
        <div className="input__box relative">
          <input type="text" className="search__box " placeholder="search" />
          <div className="search__box__btn absolute">
            <svg
              viewBox="0 0 24 24"
              preserveAspectRatio="xMidYMid meet"
              focusable="false"
      ...
      <div className="header__right__items d__flex align__items__center ">
        <div className="create_container top__menu__icons pointer">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
        ...
        <div className="app_container top__menu__icons pointer">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
        ...
        <div className="notification_container top__menu__icons pointer">
          <svg
            viewBox="0 0 24 24"
            preserveAspectRatio="xMidYMid meet"
            focusable="false"
        ...
        <div className="email_container top__menu__icons pointer">
            <img src={userImg} alt=""/>
        </div>
      </div>
    </div>
