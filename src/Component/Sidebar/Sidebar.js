...
const Sidebar = () => {
  return (
    <div className="Sidebar pointer">
      <div className="sidebar__items d__flex align__items__center justify__content__center ">
        <svg
          viewBox="0 0 24 24"
        ...
        >
          <g class="style-scope yt-icon">
            <path
              ...
              class="style-scope yt-icon mx-5"
            ></path>
          </g>
        </svg>
      ...
      <div className="sidebar__items d__flex align__items__center justify__content__center ">
        ...
        <span className="sidebar_txt">Explore</span>
      </div>
      ...
      <div className="sidebar__items d__flex align__items__center justify__content__center ">
        ...
        <span className="sidebar_txt">Shorts</span>
      </div>
      ...
      <div className="sidebar__items d__flex align__items__center justify__content__center ">
        ...
        <span className="sidebar_txt">Subscription</span>
      </div>
      ...
      <div className="sidebar__items d__flex align__items__center justify__content__center ">
        ...
        <span className="sidebar_txt">Library</span>
      </div>
    </div>
  );
};
